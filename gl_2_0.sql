...
-- histories before 2.0 {{{
INSERT INTO histories
  SELECT apis.id, versions.id, 1 FROM apis, versions
    WHERE versions.name IS 'GL' AND versions.major == 2 AND versions.minor == 0;
...
UPDATE histories SET status = 0 WHERE
  histories.version_id IN (
    ...
    WHERE v.name IS 'GL' AND v.major == 1 AND v.minor == 5 AND
...
INSERT INTO apis (name) VALUES ('BackColor');
INSERT INTO apis (name) VALUES ('BackSecondaryColor');
...
INSERT INTO apis (name) VALUES ('DepthTest');
...
INSERT INTO apis (name) VALUES ('FogColor');
-- INSERT INTO apis (name) VALUES ('FogCoord');
-- INSERT INTO apis (name) VALUES ('FogCoordPointer');
INSERT INTO apis (name) VALUES ('FogFragCoord');
INSERT INTO apis (name) VALUES ('FragData');
INSERT INTO apis (name) VALUES ('FragDepth');
INSERT INTO apis (name) VALUES ('FrontColor');
-- INSERT INTO apis (name) VALUES ('FrontFace');
INSERT INTO apis (name) VALUES ('FrontFacing');
INSERT INTO apis (name) VALUES ('FrontSecondaryColor');
...
INSERT INTO apis (name) VALUES ('GetAttachShaders');
INSERT INTO apis (name) VALUES ('GetAttribLocation');
-- INSERT INTO apis (name) VALUES ('GetBooleanv');
INSERT INTO apis (name) VALUES ('GetBufferParameter');
INSERT INTO apis (name) VALUES ('GetBufferParameteriv');
INSERT INTO apis (name) VALUES ('GetBufferPointer');
...
INSERT INTO apis (name) VALUES ('Uniform');
INSERT INTO apis (name) VALUES ('Uniform2');
INSERT INTO apis (name) VALUES ('Uniform4');
INSERT INTO apis (name) VALUES ('UniformMatrix');
INSERT INTO apis (name) VALUES ('UniformMatrix3');
...
INSERT INTO apis (name) VALUES ('VertexAttrib');
...
INSERT INTO histories (api_id, version_id, status)
  SELECT * FROM (
    ...
    CROSS JOIN
    (SELECT * FROM (
      SELECT id, 2 FROM versions WHERE name IS 'GL' AND major == 2 AND minor == 0
      UNION
      SELECT id, 0 FROM versions WHERE name IS 'GL' AND major < 2)));
-- }}}
END;
-- vim: fdm=marker
